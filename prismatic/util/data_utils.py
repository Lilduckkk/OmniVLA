...
class PaddedCollatorForActionPrediction_Nav_MMN:
    ...
    def __call__(self, instances: Sequence[Dict[str, torch.Tensor]]) -> Dict[str, torch.Tensor]:
        ...
        segmentation_mask = [instance["segmentation_mask"] for instance in instances]
        segmentation_mask = torch.stack(segmentation_mask)
        ...
        output = dict(
            ...
            actions=actions,
            # 添加 original_normalized_trajectory, segmentation_mask到输出字典中 (新增!)
